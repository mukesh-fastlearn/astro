    ...
    <div className="bg-vedic-gradient min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-28 pb-16">
        <div className="text-center mb-10">
          <h1 className="font-serif text-3xl md:text-5xl font-bold text-gray-900">Contact Abhishek Soni</h1>
        ...
        <div className="grid gap-8 md:grid-cols-5">
          <div className="md:col-span-2 space-y-4">
            ...
            <Info icon={Phone} label="Call / WhatsApp" value={CONTACT.phone} />
          ...
          <div className="md:col-span-3 bg-white rounded-[2rem] border border-gray-100 p-7 shadow-sm">
            {sent ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mt-2">Abhishek Soni will get back to you shortly. 🙏</p>
              </div>
            ) : (
              <form
                onSubmit={(e) => {
              ...
              >
                ...
                <textarea required rows={4} className={inputCls} placeholder="How can Abhishek Soni help you?" />
